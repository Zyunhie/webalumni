        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-center">
            ...
            <div class="bg-white rounded-xl shadow-md p-8 hover:shadow-lg transition">
                ...
                <div id="fakultasS1" class="relative mt-6 text-left">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg shadow-sm space-y-4">
                            ...
                            <div>
                                ...
                                <ul class="ml-5 mt-2 list-disc text-gray-700 space-y-1">
                                    <li><a href="{{ route('alumni.s1.pai.index') }}"
                                            class="alumni-link disabled-link">Pendidikan Agama Islam (PAI)</a></li>
                                    <li><a href="{{ route('alumni.s1.pgmi.index') }}"
                                            class="alumni-link disabled-link">Pendidikan Guru Madrasah Ibtidaiyah (PGMI)</a>
                                    </li>
                                    <li><a href="{{ route('alumni.s1.piaud.index') }}"
                                            class="alumni-link disabled-link">Pendidikan Islam Anak Usia Dini (PIAUD)</a>
                                    </li>
                                    <li><a href="{{ route('alumni.s1.mpi.index') }}"
                                            class="alumni-link disabled-link">Manajemen Pendidikan Islam (MPI)</a></li>
                                    <li><a href="{{ route('alumni.s1.bkpi.index') }}"
                                            class="alumni-link disabled-link">Bimbingan dan Konseling Pendidikan Islam
                                            (BKPI)</a></li>
                                </ul>
                            </div>
                            <!-- FEBI -->
                            <div>
                                ...
                                <ul class="ml-5 mt-2 list-disc text-gray-700 space-y-1">
                                    <li><a href="{{ route('alumni.s1.eksyar.index') }}"
                                            class="alumni-link disabled-link">Ekonomi Syari'ah (Eksyar)</a></li>
                                </ul>
                            </div>
                            <!-- Syariah & Hukum -->
                            <div>
                                ...
                                <ul class="ml-5 mt-2 list-disc text-gray-700 space-y-1">
                                    <li><a href="{{ route('alumni.s1.as.index') }}" class="alumni-link disabled-link">Hukum
                                            Keluarga Islam (AS)</a></li>
                                    <li><a href="{{ route('alumni.s1.htn.index') }}" class="alumni-link disabled-link">Hukum
                                            Tata Negara (HTN)</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <!-- Efek gradien pudar -->
                    <div id="fadeS1"
                        class="fade-gradient absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-white via-white to-transparent pointer-events-none">
                    </div>
                </div>
            </div>
                    ...
                    <div id="contentS2" class="collapsible-content max-h-48 overflow-hidden transition-all duration-300">
                        <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                            <ul class="ml-5 list-disc text-gray-700 space-y-1">
                                <li><a href="{{ route('alumni.s2.pai.index') }}"
                                        class="alumni-link disabled-link">Pendidikan Agama Islam (PAI)</a></li>
                            </ul>
                        </div>
                    </div>
