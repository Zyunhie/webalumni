    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-900">Informasi Lowongan</h3>
                <p class="mt-1 text-sm text-gray-600">Isi detail lowongan kerja untuk alumni.</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.lowongan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="shadow sm:overflow-hidden sm:rounded-md">
                    <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="5" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm">{{ old('deskripsi') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="kualifikasi" id="kualifikasi" rows="5" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm">{{ old('kualifikasi') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="cara_melamar" id="cara_melamar" rows="3" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm">{{ old('cara_melamar') }}</textarea>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <label class="inline-flex items-center">
                                    <input type="radio" name="is_internal" value="1" {{ old('is_internal', '1') == '1' ? 'checked' : '' }}
                                ...
                                <label class="inline-flex items-center ml-6">
                                    <input type="radio" name="is_internal" value="0" {{ old('is_internal') == '0' ? 'checked' : '' }}
                                        class="border-gray-300 text-green-600 shadow-sm focus:ring-green-500">
                    ...
                    <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                        <a href="{{ route('admin.lowongan.index') }}" class="inline-flex justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 mr-3">Batal</a>
                        <button type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-green-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
