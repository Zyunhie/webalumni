...
<section class="relative">
    <img src="{{ asset('images/hero-berita.jpg') }}" alt="Hero Loker" class="w-full h-72 object-cover">
    <div class="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center text-white">
        ...
        <p class="mt-2 text-sm">
            <a href="{{ route('welcome') }}" class="hover:underline">Beranda</a> > Lowongan Pekerjaan
        </p>
    </div>
</section>
